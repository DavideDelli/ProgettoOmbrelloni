...
<div class="container">
    ...
    <main>
        <div class="form-prenotazione glass-panel" style="text-align: center;">
            <h3 style="color: #FFB3B3; border-color: #FFB3B3;">Sei assolutamente sicuro?</h3>
            <p>Stai per eliminare definitivamente il tuo account <strong><?= htmlspecialchars($nome_cliente) ?></strong> (Codice: <?= htmlspecialchars($codice_cliente) ?>).</p>
            <p><strong>Questa azione è irreversibile.</strong> Tutte le tue prenotazioni future verranno cancellate e non potrai più accedere al tuo profilo.</p>
            <form method="POST" action="elimina_account.php" style="margin-top: 30px; display: flex; justify-content: space-between; align-items: center;">
                ...
                <a href="../../profilo.php" class="button-link" style="background: rgba(0,0,0,0.2) !important;">Annulla</a>
                <button type="submit" style="background: #B22222 !important;">Sì, Elimina il mio Account</button>
            </form>
        </div>
    </main>
